...
import type { ClassValue, FitViewOptions, StyleValue } from '../../types';
...
@Component({
  ...
  template: `
    <ng-flow-panel
      [class]="panelClasses()"
      [position]="position()"
      data-testid="ng-flow__controls"
      [attr.aria-label]="store.ariaLabelConfig['controls.ariaLabel']"
      [style]="style()"
    >
      ...
      @if (showZoom()) {
        <button
          ...
          [attr.title]="store.ariaLabelConfig['controls.zoomIn.ariaLabel']"
          [attr.aria-label]="store.ariaLabelConfig['controls.zoomIn.ariaLabel']"
        ...
        <button
          ...
          [attr.title]="store.ariaLabelConfig['controls.zoomOut.ariaLabel']"
          [attr.aria-label]="store.ariaLabelConfig['controls.zoomOut.ariaLabel']"
      ...
      @if (showFitView()) {
        <button
          ...
          (click)="onFitView()"
          [attr.title]="store.ariaLabelConfig['controls.fitView.ariaLabel']"
          [attr.aria-label]="store.ariaLabelConfig['controls.fitView.ariaLabel']"
          [bgColor]="buttonBgColor()"
          [bgColorHover]="buttonBgColorHover()"
          [color]="buttonColor()"
          [colorHover]="buttonColorHover()"
      ...
      @if (showLock()) {
        <button
          ...
          [attr.title]="store.ariaLabelConfig['controls.interactive.ariaLabel']"
          [attr.aria-label]="store.ariaLabelConfig['controls.interactive.ariaLabel']"
          [bgColor]="buttonBgColor()"
          [bgColorHover]="buttonBgColorHover()"
          [color]="buttonColor()"
          [colorHover]="buttonColorHover()"
...
export class ControlsComponent {
  ...
  protected isInteractive = computed(
    () => this.store.nodesDraggable || this.store.nodesConnectable || this.store.elementsSelectable
  );
  protected minZoomReached = computed(() => this.store.viewport.zoom <= this.store.minZoom);
  protected maxZoomReached = computed(() => this.store.viewport.zoom >= this.store.maxZoom);
  protected panelClasses = computed(() =>
    cc(['ng-flow__controls', this.orientation() === 'horizontal' ? 'horizontal' : 'vertical', this.class()])
  );
  ...
  protected onToggleInteractivity() {
